...
#read_data("rotate_3.csv") |> write_csv(here("data/final/rotate_3.csv"))
...
read_csv(here("data/final/rotate_3.csv")) -> foo

do_diff("rotate_3.csv")
```

Rotate 4 is (mostly) done -- could always use more clean up, but pretty good!
